    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <section className="bg-white rounded-xl border shadow-sm p-5 space-y-3">
        ...
        <PushNotificationSettings
          ...
          initialPreferences={{
            notifyNewCoverRequest: member.notifyNewCoverRequest,
            notifyAnnouncement: member.notifyAnnouncement,
            notifyStaleCoverReminder: member.notifyStaleCoverReminder,
            notifyMyRequestUpdates: member.notifyMyRequestUpdates,
          }}
        />
      </section>
